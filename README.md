...
This repository collects small, self-contained examples of how to use
[jPipe](https://github.com/jpipe-mcscert/), the justification pipeline
for building and analysing justification diagrams.

Each example is intentionally kept minimal and standalone so that it can be
read, run, and reused on its own — the goal is to illustrate a specific jPipe
feature or workflow without the overhead of a larger project.
